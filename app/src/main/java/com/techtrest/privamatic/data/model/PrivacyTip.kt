...
object PrivacyTips {
    ...
    private val issueAwareTips = listOf(
        ...
        PrivacyTip(
            ...
            content = "Google Maps is excellent, but it logs every search, route, and visit to your Google account. If you mainly need offline navigation, CoMaps offers that without any tracking.",
            layer = TipLayer.ISSUE_AWARE,
